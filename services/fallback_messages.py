...
def _low_energy(context: UserAIContext) -> str:
    if context.bro_boost_allowed:
        return (
            "Брат, понял. Похоже, ты реально вымотался, а не просто ленишься.\n\n"
            "Не буду сейчас читать лекцию и тащить тебя в подвиг. "
            "Если хочешь, просто напиши, что сильнее всего давит: усталость, тревога, куча задач или чувство, что все навалилось.\n\n"
            "Если разговор сейчас вообще не заходит, можно совсем коротко: «устал», «бесит», «не вывожу». Я подхвачу."
        )

    if context.active_tasks:
        return (
            "Понял. Когда задач много, от них можно просто устать и начать внутренне отъезжать.\n\n"
            "Не будем сейчас тащить весь список на себя сразу. "
            "Если хочешь, просто скажи, что бесит больше всего: объем, страх начать, чувство вины или то, что все висит.\n\n"
            "Можно даже одним словом. Я не буду сразу превращать это в план."
        )

    return (
        "Понял. Похоже, ты просто вымотался.\n\n"
        "Не обязательно сейчас срочно собирать себя в кучу. Можешь просто написать, что с тобой происходит, как есть.\n\n"
        "Если потом захочешь, вместе решим: тебе сейчас нужен разговор, пауза или один маленький шаг."
    )
...
def _general_chat(context: UserAIContext, user_message: str | None) -> str:
    ...
    if any(
        ...
        return (
            "Могу. Не обязательно все сводить к задачам.\n\n"
            "Если хочешь, просто напиши, что у тебя сейчас давит или крутится в голове. "
            "Я отвечу нормально, без пинка и без плана."
        )
    ...
    if any(
        ...
        return (
            "Понимаю. Когда задач становится слишком много, от них правда можно устать.\n\n"
            "Можешь не собирать мысль красиво. Просто напиши, что сильнее всего давит сейчас, "
            "а я сначала выслушаю."
        )

    if normalized in {"привет", "здравствуй", "здравствуйте", "хай", "hello", "hi"} or normalized.startswith(("привет ", "здравствуй ", "здравствуйте ", "хай ")):
        return "Я тут. Можем просто поговорить, а можем что-то спокойно разобрать."

    if normalized in {"спасибо", "спс"}:
        return "Всегда пожалуйста. Если хочешь, можем дальше просто пообщаться."
    ...
    return (
        "Я здесь. Можем просто поговорить, можем спокойно разобрать, что давит, "
        "а к задачам перейти только если тебе это правда нужно.\n\n"
        "Пиши как есть, без правильной формулировки."
    )
